<template>
    <div class="blogs">
        ...
        <div class="wrapper">
            <div class="top">
                <div class="title"><h1>Send An Alert</h1></div>
            </div>
            <div class="abc">
                <main class="container">
                    <form @submit.prevent="send1">
                      ...
                      <div class="form-floating">
                        <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" fdprocessedid="mzryah" v-model="email">
                        <label for="floatingInput">Email</label>
                      </div>
                      <div class="form-floating">
                        <textarea name=""  class="form-control" id="floatingInput" placeholder="name@example.com" cols="30" rows="10" v-model="dt"></textarea>
                        <label for="floatingPassword">Disaster Type</label>
                      </div>
                      <div class="form-floating">
                        <textarea name=""  class="form-control" id="floatingInput" placeholder="name@example.com" cols="30" rows="10" v-model="alertMsg"></textarea>
                        <label for="floatingPassword">Alert Message</label>
                      </div>
                      <button class="btn btn-primary w-100 py-2" type="submit" fdprocessedid="e845cp">Submit</button>
            
                    </form>
                    <p>Don't Wanna Create? &nbsp; &nbsp; &nbsp; &nbsp;<button class="add" @click="back"> Go Back </button></p>
                </main>
            </div>
    ...
    methods:{
        ...
        async send1(){
            ...
            if(r.status==200){
                ...
                this.$router.push({path:`/user_dashboard/${this.$route.params.id}`})
            }
        }
    }
}
