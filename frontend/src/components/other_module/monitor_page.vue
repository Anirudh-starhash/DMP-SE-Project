                ...
                <div class="row g-0">
                  <div class="col-md-12">
                    <div class="card-body">
                      ...
                      <div class="row1">
                        <div class="label">Blogs Written:</div>
                        <div class="value" :class="[isDarkMode ? 'h2dark' : 'h2light']">{{ user.blog_count }}</div>
                      </div>
                      <div class="row1">
                        <div class="label">Reviews Written:</div>
                        <div class="value" :class="[isDarkMode ? 'h2dark' : 'h2light']">{{ user.review_count }}</div>
                      </div>
