      ...
      <div class="main">
        ...
        <div class="row">
          <form method="post" @submit.prevent="user_register">
            <div class="mb-7">
              <label for="exampleInputfirst name1" class="form-label"><p class="x">Name</p></label>
              <input type="text" class="form-control" id="exampleInputfirstname1" aria-describedby="emailHelp" required v-model="name">
            </div>
            <div class="mb-7">
        ...
        <div class="buttons">
          <div>
            <a href="/login_page">
              <button :class="['btn', isDarkMode ? 'btn-dark' : 'btn-primary', 'p-3', 'lh-1']">Login</button>
            </a>
          </div>
          <div>
            <a href="/">
              <button :class="['btn', isDarkMode ? 'btn-dark' : 'btn-primary', 'p-3', 'lh-1']">Home</button>
            </a>
          </div>
        </div>
      </div>
