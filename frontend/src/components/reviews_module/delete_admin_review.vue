<template>
    <div :class="[isDarkMode?'dark':'main-class']">
        ...
        <div class="main-content">
          <h2 :class="[isDarkMode?'h2dark':'h2light']">Do you really want to Delete the review?</h2>
          <div class="buttons">
     ...
     methods: {
       ...
       back(){
        ...
        async delete_(){
           ...
           const r=await axios.delete(`http://127.0.0.1:5000/api/delete_admin_review/${this.$route.params.id}/${this.id}`);
           if(r.status==200){
               alert(r.data.msg);
